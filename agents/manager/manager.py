...
class NexoManager:
    ...
    def create_task(self, request: str) -> Task:
        ...
        return Task(request=request, objective=objective, intent=intent, agent=intent)

    def structured_task(self, request: str, *, task_id: str | None = None, dependencies: list[str] | None = None, required_tools: list[str] | None = None, expected_result: str = "", priority: str = "normal", parameters: dict[str, Any] | None = None) -> Task:
